...
const ActionMenuComponent = ({ actions, style, editor, onMouseEnter, selectedAction, onClose }) => {
  return (
    <div className="absolute z-[9999] m-0 left-0 top-0 right-auto bottom-auto" style={style}>
