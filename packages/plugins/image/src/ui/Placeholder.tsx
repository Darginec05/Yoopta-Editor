...
const Placeholder = ({ attributes, children, blockId, loadingState, onUpdateLoadingState }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="yoo-image-font-medium">{loadingState?.loading ? 'Loading...' : 'Click to add image'}</span>
        {loadingState?.loading && (
          <div
